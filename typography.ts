  ...
  return {
    ...
    DEFAULT: {
      css: {
        ...
        "--tw-prose-underline-hover": theme("colors.blue.700"),
        ...
        "--tw-prose-invert-links-hover": theme("colors.blue.600"),
        "--tw-prose-invert-underline": theme("colors.blue.600 / 0.3"),
        "--tw-prose-invert-underline-hover": theme("colors.blue.600"),
